...
import { Feature, Room, Corridor } from './features.js';
import { RNG } from '../rng';
import { ROT } from '../rot';
...
//		console.log("wall", x, y);
  ...
  _firstRoom():void
  {
    ...
    let room = ROT.Map.Feature.Room.createRandomCenter(cx, cy, this._options);
  ...
  {
    let feature = RNG.getWeightedValue(this._features);
